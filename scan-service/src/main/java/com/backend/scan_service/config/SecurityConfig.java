...
import com.backend.scan_service.constants.InternalHeaders;
import com.backend.scan_service.filter.CorrelationIdFilter;
import com.backend.scan_service.filter.GatewayHeaderFilter;
import com.backend.scan_service.filter.ServiceJwtValidationFilter;
import com.backend.scan_service.security.Http401EntryPoint;
import com.backend.scan_service.security.Http403Handler;
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                return http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                // Scan read — authenticated users only
