...
public class LoggingFilter implements GlobalFilter, Ordered {
        ...
        public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
                ...
                // Reuse client-supplied ID for end-to-end tracing, or generate new one
                String headerValue = request.getHeaders().getFirst(CORRELATION_ID_HEADER);
                final String correlationId = (headerValue != null && !headerValue.isEmpty())
                                ? headerValue
