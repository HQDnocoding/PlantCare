...
class MedicineResponse(MedicineBase):
    ...
    @classmethod
    def compute_disease_ids(cls, data: Any) -> Any:
        # When data comes from ORM object, extract disease ids from relationship
        if hasattr(data, "diseases"):
            data.__dict__["disease_ids"] = [d.id for d in (data.diseases or [])]
        return data
