...
public class NotificationConsumer {
    ...
    @KafkaListener(topics = "user.followed", groupId = "notification-service", concurrency = "3")
    ...
    @KafkaListener(topics = "post.commented", groupId = "notification-service", concurrency = "3")
    ...
    @KafkaListener(topics = "post.voted", groupId = "notification-service", concurrency = "3")
    ...
    @KafkaListener(topics = "comment.replied", groupId = "notification-service", concurrency = "3")
