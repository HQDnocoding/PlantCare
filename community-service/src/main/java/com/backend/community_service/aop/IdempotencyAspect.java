...
import com.backend.community_service.service.HttpIdempotencyService;
 ...
 * 1. Extracts idempotency key from request headers or generates one
 ...
 *
 * Headers:
 * - X-Idempotency-Key: Client-provided unique key for this request
 * - X-Correlation-Id: Can be reused as idempotency key if no explicit key
 */
@Aspect
@Component
