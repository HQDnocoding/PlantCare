...
import com.backend.community_service.filter.CorrelationIdFilter;
import com.backend.community_service.filter.GatewayHeaderFilter;
import com.backend.community_service.filter.ServiceJwtValidationFilter;
import com.backend.community_service.security.Http401EntryPoint;
import com.backend.community_service.security.Http403Handler;
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                return http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/v1/posts/feed/following")
                                                .hasAnyRole("FARMER", "ADMIN")

                                                // Global feed + read APIs — guests allowed
                                                .requestMatchers(HttpMethod.GET, "/api/v1/posts/feed/global/new")
                                                .hasAnyRole("GUEST", "FARMER", "ADMIN")
                                                ...
                                                // Write APIs — authenticated users only
