...
public class IdempotencyAspect {
    ...
    public Object handleIdempotency(ProceedingJoinPoint joinPoint, Idempotent idempotent) throws Throwable {
        ...
        try {
            ...
            if (userId == null) {
                log.error("No user ID found in security context - authentication may be bypassed");
                throw new IllegalStateException("User authentication required for idempotency");
            }
