...
public class KafkaTopicConfig {
    ...
    @Value("${app.kafka.topics.user-profile-result:user.profile.result}")
    private String userProfileResultTopic;
    ...
    @Bean
    public NewTopic userProfileResultTopic() {
        return TopicBuilder.name(userProfileResultTopic).partitions(partitions).replicas(replicas).build();
    }
}
