...
import com.backend.user_service.constants.InternalHeaders;
import com.backend.user_service.filter.CorrelationIdFilter;
import com.backend.user_service.filter.GatewayHeaderFilter;
import com.backend.user_service.filter.ServiceJwtValidationFilter;
import com.backend.user_service.security.Http401EntryPoint;
import com.backend.user_service.security.Http403Handler;
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                return http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                // Authenticated reads (e.g. my profile, followers list)
